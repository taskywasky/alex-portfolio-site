      ...
      ">
        ...
        ">
          ...
          <div className="flex gap-0.5 sm:gap-1">
            <div className="w-2 h-2 sm:w-2.5 sm:h-2.5 rounded-full bg-[#03fc03] border border-[#808080]" />
            <div className="w-2 h-2 sm:w-2.5 sm:h-2.5 rounded-full bg-[#fce803] border border-[#808080]" />
            <div className="w-2 h-2 sm:w-2.5 sm:h-2.5 rounded-full bg-[#fc0303] border border-[#808080]" />
          </div>
        </div>
        <div className="px-2 sm:px-3 py-1.5 sm:py-2 bg-white/60">
          <p className="text-[#1a1a2e] leading-relaxed">{message}</p>
        </div>
        <div className="
          px-1.5 sm:px-2 py-0.5 sm:py-1 text-[9px] sm:text-[10px] text-[#3a3a4a] tracking-wide
...
export default function ChatBubbles() {
  ...
  return (
    <>
      ...
      <div className="fixed left-0 top-0 h-full w-0 md:w-[calc(50%-384px)] lg:w-[calc(50%-512px)] pointer-events-none z-20 overflow-hidden">
      ...
      <div className="fixed right-0 top-0 h-full w-0 md:w-[calc(50%-384px)] lg:w-[calc(50%-512px)] pointer-events-none z-20 overflow-hidden">
        {Array.from({ length: count }).map((_, i) => (
